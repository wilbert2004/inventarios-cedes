module.exports = {
  ...
  custody_products: `
    CREATE TABLE IF NOT EXISTS custody_products (
      ...
      product_status TEXT CHECK(product_status IN ('EN_TRANSITO','EN_RESGUARDO')) NOT NULL DEFAULT 'EN_TRANSITO',
      reference_folio TEXT,
      center_origin TEXT,
      notes TEXT,
      ...
      motivo_baja TEXT,
      product_image TEXT,
      product_condition TEXT DEFAULT 'BUENO' CHECK(product_condition IN ('BUENO','CASILLA_MALA','DEFECTUOSO')),
